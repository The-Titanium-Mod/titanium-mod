...
public class TitaniumLanguageProvider extends FabricLanguageProvider {
	...
	public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder baseTranslationBuilder) {
		...
		TitaniumTranslationBuilder.<Block>translation(baseTranslationBuilder).auto(
				CLART, SOD, WILDWOOD_LOG, WILDWOOD_GRASS, WILDWOOD_LUMEN, WILDWOOD_BLISTER, SMALL_TEETH,
				GIANT_TOOTH, TALL_WILDWOOD_GRASS, ROTTEN_SOD, ROTTING_WILDWOOD_GRASS, ROTTEN_WILDWOOD_GRASS,
				ROTTEN_TOOTH, VEINY_CLART, VEINY_SOD, BLUE_VOLLON, RED_VOLLON, BUNNY_CATCHER, VOLLON_NOODLES,
				VOLLON_BRONCHI, VOLLON_STRINGS, TENDON, HANGING_TENDON, BRAWN, SALT, BLOOD
		).autoWithOfNotation(
